...
Base inicial: seed extraido do dominio de agendamentos e contratos publicos em `contracts/public`.

## Runtime atual

- `server.js` inicializa o NestJS app standalone em `APPOINTMENTS_API_PORT` ou `PORT`.

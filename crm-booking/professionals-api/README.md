...
Base inicial: seed extraido do dominio de profissionais.

## Runtime atual

- `server.js` inicializa o NestJS app standalone em `PROFESSIONALS_API_PORT` ou `PORT`.
- `createProfessionalsServiceApp.js` cria e configura o Nest app com headers, CORS, auth interna, metrics, health e filtros de erro.

...
const SERVICE_PROXY_CONFIGS = {
  appointments: {
    ...
    targetName: 'appointments-api',
    urlEnv: 'APPOINTMENTS_API_URL',
    tokenEnv: 'APPOINTMENTS_API_INTERNAL_TOKEN',
    unavailableMessage: 'Serviço de agendamentos indisponível',
  },
  customers: {
    routePrefix: '/api/customers',
    targetName: 'customers-api',
    urlEnv: 'CUSTOMERS_API_URL',
    tokenEnv: 'CUSTOMERS_API_INTERNAL_TOKEN',
    unavailableMessage: 'Serviço de clientes indisponível',
  },
  services: {
    routePrefix: '/api/services',
    targetName: 'services-api',
    urlEnv: 'SERVICES_API_URL',
    tokenEnv: 'SERVICES_API_INTERNAL_TOKEN',
    unavailableMessage: 'Serviço de serviços indisponível',
  },
  professionals: {
    routePrefix: '/api/professionals',
    targetName: 'professionals-api',
    urlEnv: 'PROFESSIONALS_API_URL',
    tokenEnv: 'PROFESSIONALS_API_INTERNAL_TOKEN',
